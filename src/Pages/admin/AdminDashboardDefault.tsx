  ...
  return (
    <div className="h-full mb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
        {/* Active Users */}
        <div className="bg-blue-500 shadow-lg rounded-md flex items-center justify-between p-3 text-white font-medium group">
          <div className="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
            <svg
              ...
              viewBox="0 0 24 24"
              stroke="currentColor"
              className="stroke-current text-blue-500 transform transition-transform duration-500 ease-in-out"
            >
              <path
                strokeLinecap="round"
        ...
        <div className="bg-blue-500 shadow-lg rounded-md flex justify-between p-3 text-white font-medium group">
          <div className="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
            <svg
              width="30"
              height="30"
